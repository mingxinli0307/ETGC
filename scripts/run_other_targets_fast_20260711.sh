...
OUT_DIR="logs/other_targets_fast_20260711"
...
run_case brain_state_s500_viewmpstd_e5 brain \
  "${STATE_S500[@]}" --feature_path emb/brain_viewmp_std.emb

run_case brain_forest_s2_viewmpstd_e5 brain \
  "${FOREST_S2[@]}" --feature_path emb/brain_viewmp_std.emb

run_case arxivcs_state_s2_eval1_e5 arXivCS \
  "${STATE_S2[@]}"

run_case arxivcs_state_s2_lr3e4_b2048_e5 arXivCS \
  "${STATE_S2[@]}" --learning_rate 0.0003 --batch_size 2048

run_case arxivai_state_s500_viewmp_e5 arXivAI \
  "${STATE_S500[@]}" --feature_path "dataset/arXivAI/MVC Features/View_MP.txt"

run_case arxivai_forest_s2_viewmp_e5 arXivAI \
  "${FOREST_S2[@]}" --feature_path "dataset/arXivAI/MVC Features/View_MP.txt"
