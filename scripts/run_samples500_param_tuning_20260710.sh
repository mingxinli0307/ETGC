...
OUT_DIR="logs/samples500_param_tuning_20260710"
...
run_case dblp_lr3e4_ncut1_proj04_e15 dblp \
  "${COMMON_S500[@]}" \
  --batch_size 1024 \
  --epoch 15 \
...
run_case dblp_lr3e4_ncut1_proj03_e15 dblp \
  "${COMMON_S500[@]}" \
  --batch_size 1024 \
  --epoch 15 \
  --learning_rate 0.0003 \
...
run_case dblp_lr5e5_ncut05_proj04_e20 dblp \
  "${COMMON_S500[@]}" \
  --batch_size 1024 \
  --epoch 20 \
...
run_case patent_lr3e4_ncut1_proj02_b1024_e25 patent \
  "${COMMON_S500[@]}" \
  --batch_size 1024 \
  --epoch 25 \
  --learning_rate 0.0003 \
...
run_case patent_lr3e4_ncut1_proj03_b1024_e25 patent \
  "${COMMON_S500[@]}" \
  --batch_size 1024 \
  --epoch 25 \
  --learning_rate 0.0003 \
...
run_case patent_lr1e4_ncut1_proj02_b1024_e25 patent \
  "${COMMON_S500[@]}" \
  --batch_size 1024 \
  --epoch 25 \
