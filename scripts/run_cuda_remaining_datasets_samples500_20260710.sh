...
OUT_DIR="logs/cuda_remaining_samples500_20260710"
...
run_case school "${OUT_DIR}/school_cuda_samples500.log" \
  "${COMMON_ARGS[@]}" \
  --edge_neighbor_k 10 \
  --batch_size 1024 \
  --epoch 30 \
...
run_case dblp "${OUT_DIR}/dblp_cuda_samples500.log" \
  "${COMMON_ARGS[@]}" \
  --edge_neighbor_k 3 \
  --batch_size 1024 \
  --epoch 30 \
...
run_case patent "${OUT_DIR}/patent_cuda_samples500.log" \
  "${COMMON_ARGS[@]}" \
  --edge_neighbor_k 3 \
  --batch_size 512 \
  --epoch 25 \
