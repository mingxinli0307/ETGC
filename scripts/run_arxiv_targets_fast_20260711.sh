...
OUT_DIR="logs/arxiv_targets_fast_20260711"
...
run_case arxivcs_state_s2_ncut1_proj02_e5 arXivCS \
  "${STATE_S2[@]}" --lambda_edge_ncut 1.0 --lambda_proj 0.2

run_case arxivai_state_s500_viewmp_e5 arXivAI \
  "${STATE_S500[@]}" --feature_path "dataset/arXivAI/MVC Features/View_MP.txt"

run_case arxivai_state_s2_viewmp_e5 arXivAI \
  "${STATE_S2[@]}" --feature_path "dataset/arXivAI/MVC Features/View_MP.txt"

run_case arxivai_state_s500_viewmp_lr3e4_b2048_e5 arXivAI \
  "${STATE_S500[@]}" --feature_path "dataset/arXivAI/MVC Features/View_MP.txt" \
