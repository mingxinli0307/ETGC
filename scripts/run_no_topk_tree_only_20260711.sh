...
OUT_DIR="logs/no_topk_tree_only_20260711"
...
run_case arxivcs_state_s10_topk0_e5 arXivCS \
  "${STATE_TREE_ONLY[@]}"

run_case arxivai_state_s10_topk0_e5 arXivAI \
  "${STATE_TREE_ONLY[@]}"

run_case brain_state_s10_topk0_e5 brain \
  "${STATE_TREE_ONLY[@]}"
